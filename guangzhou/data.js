...
const guangzhouLottoData = {
    ...
    drawHistory: [
        ...
        { date: "2026-04-14", numbers: [8, 3, 7, 4] },
        { date: "2026-04-13", numbers: [5, 2, 8, 6] },
        { date: "2026-04-12", numbers: [2, 6, 4, 5] },
        { date: "2026-04-11", numbers: [4, 1, 5, 0] },
        { date: "2026-04-10", numbers: [3, 6, 7, 8] },
        { date: "2026-04-09", numbers: [3, 2, 2, 1] },
        { date: "2026-04-08", numbers: [3, 7, 9, 2] },
        { date: "2026-04-07", numbers: [4, 1, 0, 8] },
        { date: "2026-04-06", numbers: [1, 0, 2, 8] },
        { date: "2026-04-05", numbers: [6, 7, 2, 4] },
        { date: "2026-04-04", numbers: [5, 2, 7, 6] },
        { date: "2026-04-03", numbers: [9, 9, 3, 4] },
        { date: "2026-04-02", numbers: [1, 3, 2, 6] },
        { date: "2026-04-01", numbers: [1, 0, 2, 0] },
        ...
        { date: "2026-03-27", numbers: [6, 8, 4, 9] },
        { date: "2026-03-26", numbers: [1, 6, 9, 4] },
        { date: "2026-03-25", numbers: [0, 6, 8, 9] },
        { date: "2026-03-24", numbers: [3, 5, 7, 2] },
        { date: "2026-03-23", numbers: [7, 5, 3, 3] },
        { date: "2026-03-22", numbers: [8, 4, 7, 5] },
        { date: "2026-03-21", numbers: [2, 1, 9, 7] },
        { date: "2026-03-20", numbers: [7, 0, 2, 3] },
        { date: "2026-03-19", numbers: [3, 9, 2, 8] },
        { date: "2026-03-18", numbers: [3, 5, 7, 8] },
        { date: "2026-03-17", numbers: [8, 5, 3, 6] },
        { date: "2026-03-16", numbers: [7, 6, 9, 3] },
        { date: "2026-03-15", numbers: [3, 6, 6, 6] },
        { date: "2026-03-14", numbers: [3, 6, 5, 4] },
        { date: "2026-03-13", numbers: [3, 2, 6, 4] },
        { date: "2026-03-12", numbers: [3, 6, 5, 8] },
        { date: "2026-03-11", numbers: [4, 0, 4, 1] },
        { date: "2026-03-10", numbers: [2, 8, 2, 0] },
        { date: "2026-03-09", numbers: [9, 2, 3, 5] },
        { date: "2026-03-08", numbers: [2, 3, 7, 1] },
        { date: "2026-03-07", numbers: [0, 6, 2, 9] },
        { date: "2026-03-06", numbers: [3, 4, 8, 6] },
        { date: "2026-03-05", numbers: [9, 4, 2, 1] },
        { date: "2026-03-04", numbers: [7, 6, 5, 8] },
        { date: "2026-03-03", numbers: [9, 2, 4, 4] },
        { date: "2026-03-02", numbers: [2, 1, 0, 6] },
        { date: "2026-03-01", numbers: [3, 9, 0, 9] },
        
        // Data untuk Februari 2026
        { date: "2026-02-28", numbers: [0, 3, 0, 8] },
        { date: "2026-02-27", numbers: [1, 0, 7, 2] },
        ...
        { date: "2026-02-21", numbers: [4, 1, 6, 7] },
        { date: "2026-02-20", numbers: [0, 5, 3, 0] },
        { date: "2026-02-19", numbers: [6, 9, 2, 5] },
        { date: "2026-02-18", numbers: [9, 5, 3, 6] },
        { date: "2026-02-17", numbers: [2, 0, 1, 1] },
        { date: "2026-02-16", numbers: [1, 2, 5, 0] },
        { date: "2026-02-15", numbers: [0, 1, 1, 3] },
        { date: "2026-02-14", numbers: [3, 4, 1, 5] },
        { date: "2026-02-13", numbers: [1, 1, 6, 8] },
